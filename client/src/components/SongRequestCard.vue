  ...
  >
    ...
    <div v-if="songRequest.song_genre" class="px-3 mt-1 d-flex justify-content-between align-items-center">
      <div class="d-flex align-items-center w-100">
        <i class="fas fa-compact-disc me-3 icon-size"></i>
    ...
    <div v-if="incoming" class="btn-group d-flex w-100 mt-2" role="group">
      <button
        type="button"
    ...
    <div v-else class="btn-group d-flex w-100 mt-2" role="group">
      <button
        type="button"
        class="btn btn-light flex-fill w-100 px-0 py-2 d-flex flex-column align-items-center"
